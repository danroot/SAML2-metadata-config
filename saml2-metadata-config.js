...
var Saml2MetadataConfiguration = function (options) {
	...
	this.handleMetadata = function (metadata) {
		...
		self.options.identityProviderUrl = xpath
			.select('//IDPSSODescriptor/SingleSignOnService/@Location', doc)[0]
			.value.toString();
	...
	this.getMetadata = function (options) {
		return new Promise(function (resolve, reject) {
			...
			if (metadata) {
				...
				var metadataRequest = https.get(
					{ host: urlParsed.hostname, path: urlParsed.path, port: 443 },
					function (res) {
						var body = '';
						res.on('data', (chunk) => {
...
exports.configure = Saml2MetadataConfiguration;
